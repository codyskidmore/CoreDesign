...
6. [CoreDesign.Identity](#6-coredesignidentity)
   - [CoreDesign.Identity.Server](#61-coredesignidentityserver)
   - [CoreDesign.Identity.Client](#62-coredesignidentityclient)
7. [Azure Entra (Production Authentication)](#7-azure-entra-production-authentication)
8. [Shared appsettings Configuration](#8-shared-appsettings-configuration)
9. [Local NuGet Development](#9-local-nuget-development)
10. [Sample Application](#10-sample-application)
    - [Project Overview](#101-project-overview)
    - [Prerequisites and Setup](#102-prerequisites-and-setup)
    - [Sample.Identity.Web](#103-sampleidentityweb)
    - [Sample.Api](#104-sampleapi)
    - [Sample.Blazor](#105-sampleblazor)
    - [Sample.Data.MigrationService](#106-sampledatamigrationservice)
    - [Deployment](#107-deployment)
11. [Vertical Slice Architecture Reference](#11-vertical-slice-architecture-reference)
...
### 6.1 CoreDesign.Identity.Server
...
### 6.2 CoreDesign.Identity.Client
...
## 7. Azure Entra (Production Authentication)
...
## 8. Shared appsettings Configuration
...
### 10.6 Sample.Data.MigrationService
...
## 11. Vertical Slice Architecture Reference
