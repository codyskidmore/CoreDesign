...
/// Sample.Identity.Web identity server.
///
/// Authority resolution order (first match wins):
///   1. Blazor:Oidc:Authority (appsettings / env vars / user secrets)
///   2. services:SampleIdentityWeb:https:0 (Aspire-injected, normalized)
///   3. services__SampleIdentityWeb__https__0 (Aspire-injected raw)
...
public sealed class LocalOidcAuthConfigurator : IAuthProviderConfigurator
{
    ...
    public void Configure(IServiceCollection services, IConfiguration configuration)
    {
        ...
        //    - services:SampleIdentityWeb:https:0 (IConfiguration normalized form)
        //    - services__SampleIdentityWeb__https__0 (raw env var form)
        ...
        var authority =
            ...
            ?? configuration["services__SampleIdentityWeb__https__0"]
            ?? configuration.GetConnectionString("SampleIdentityWeb")
