    ...
    ILogger<MigrationService> logger) : BackgroundService
{
    ...
    protected async Task SeedDatabaseAsync(SampleApiDbContext dbContext, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            foreach (var filePath in filePaths)
            {
                ...
                var qualifiedName = $"{qualifiedClassName}, SampleApi.Api";
                ...
                var genericSeedMethod = seedMethodInfo.MakeGenericMethod(typeof(SampleApiDbContext), seedType);
    ...
    private static async Task EnsureDatabaseAsync(SampleApiDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task RunMigrationAsync(SampleApiDbContext dbContext, ILogger<MigrationService> logger,
