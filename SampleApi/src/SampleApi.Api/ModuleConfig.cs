...
public static class ModuleConfig
{
    public static IHostApplicationBuilder AddWeatherForecastsModule(this IHostApplicationBuilder builder)
    {
        ...
        s.AddTransient<IReadRepository<SampleApiDbContext, WeatherForecast>, ReadRepository<SampleApiDbContext, WeatherForecast>>();
        s.AddTransient<ICudRepository<SampleApiDbContext, WeatherForecast>, CudRepository<SampleApiDbContext, WeatherForecast>>();
